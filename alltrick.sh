...
read -p "   Bug Address (Example: www.google.com) : " abaikan
read -p "   Bug SNI/Host (Example : m.facebook.com) : " abaikan
...
sed -i '/#xray-vmess-none-tls$/a\#vms '"$user $exp $harini $uuid"'\
...
echo -e "\e[$line═════════════════════════════════\e[m"
echo -e "Link (YES)   : ${vmesslink1}"
echo -e "\e[$line═════════════════════════════════\e[m"
echo -e "Link (DIGIBOOSTER)  : ${vmesslink2}"
echo -e "\e[$line═════════════════════════════════\e[m"
echo -e "Link (DIGI-APN)     : ${vmesslink3}"
echo -e "\e[$line═════════════════════════════════\e[m"
echo -e "Link (maxis)    : ${vmesslink4}"
echo -e "\e[$line═════════════════════════════════\e[m"
...
patchnone=/xray-vmessws-none-tls
read -p "   Bug Address (Example: www.google.com) : " address
...
patchtls=/pakya-trojanwstls
patchnone=/pakya-trojanwsntls
read -p "   Bug Address (Example: www.google.com) : " address
read -p "   Bug SNI (Example : m.facebook.com) : " sni
bug_addr=${address}.
bug_addr2=$address
